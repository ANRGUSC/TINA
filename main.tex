...
in which broader neighborhood snapshots arrive at greater age, we derive an
...
$L_T=vT$. Numerical experiments verify the predicted crossover,
...
communication structure. Voulgaris, Bianchini, and Bamieh studied $H_2$ control
